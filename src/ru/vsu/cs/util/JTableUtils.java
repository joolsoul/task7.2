...
public class JTableUtils {
    ...
    {
        JButton minusRowButton = createPlusMinusButton("\u2013", changeButtonsSize);
        JButton minusColumnButton = createPlusMinusButton("\u2013", changeButtonsSize);
        JButton plusRowButton = createPlusMinusButton("+", changeButtonsSize);
        JButton plusColumnButton = createPlusMinusButton("+", changeButtonsSize);
        ...
        if (table.getParent() instanceof JViewport && table.getParent().getParent() instanceof JScrollPane) {
            ...
            if (changeRowsCountButtons || changeColsCountButtons) {
                ...
                if (changeColsCountButtons) {
                    ...
                    topPanel.add(minusColumnButton);
                    linkedComponents.add(minusColumnButton);
                    topPanel.add(setFixedSize(new Box.Filler(null, null, null), changeButtonsMargin, changeButtonsSize));
                    plusColumnButton.setName(table.getName() + "-plusColumnButton");
                    plusColumnButton.addActionListener((ActionEvent evt) ->
                    {
                    ...
                    topPanel.add(plusColumnButton);
                    linkedComponents.add(plusColumnButton);
                ...
                if (changeRowsCountButtons) {
                    ...
                    leftPanel.add(plusRowButton);
                    linkedComponents.add(plusRowButton);
